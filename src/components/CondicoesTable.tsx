...
export default function CondicoesTable() {
  ...
  useEffect(() => {
    fetchCondicoes(currentPage, debouncedSearch);
  }, [fetchCondicoes, currentPage, debouncedSearch]);
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 mt-1">Gerencie as condições e prazos de faturamento.</p>
        </div>
      </div>
      ...
      <div className="bg-slate-900/50 border border-slate-700/50 backdrop-blur-xl rounded-2xl overflow-hidden shadow-2xl">
        ...
        {error && (
          <div className="p-6 text-center text-red-400 bg-red-400/10">
            Houve um erro ao carregar as condições: {error}
          </div>
        )}
        ...
        <div className="overflow-x-auto min-h-[400px]">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-slate-400">
              ...
              <p className="text-lg font-medium">Nenhuma condição encontrada</p>
            </div>
          ) : (
              ...
              <tbody className="divide-y divide-slate-700/50 bg-slate-800/10">
                {condicoes.map((condicao) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-white">{condicao.descricao}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
