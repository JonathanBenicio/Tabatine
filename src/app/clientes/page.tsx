      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 p-8 shadow-2xl flex items-center justify-between">
        <div className="relative z-10 w-2/3">
          ...
          <p className="text-emerald-100 text-sm leading-relaxed">
            Consulte a base cadastral de clientes do Omie ERP de forma rápida e segura.
          </p>
        </div>
        ...
        <div className="w-24 h-24 absolute right-16 top-0 rounded-full bg-emerald-400/30 blur-2xl"></div>
      </div>

      {/* Clientes Table Component */}
      <ClientesTable />
