...
export default async function ReceberPage() {
  ...
  return (
    <div className="max-w-[100vw] mx-auto space-y-8 animate-in fade-in zoom-in duration-500 overflow-x-hidden">
      {/* Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 p-8 shadow-2xl flex items-center justify-between">
        <div className="relative z-10 w-full md:w-2/3">
          ...
          <p className="text-emerald-100 text-sm leading-relaxed max-w-2xl">
            Monitore seu faturamento e previsões de recebimento integradas em tempo real com o Omie ERP.
          </p>
        </div>
        ...
        <div className="w-24 h-24 absolute right-16 top-0 rounded-full bg-emerald-400/30 blur-2xl hidden md:block"></div>
      </div>

      {/* Finance Table Component */}
      <div className="w-[calc(100vw-2rem)] md:w-full overflow-hidden pb-8">
        <FinanceiroTable type="receber" />
      </div>
    </div>
  );
}
