    ...
    <div className="w-full max-w-6xl mx-auto space-y-8 animate-in fade-in zoom-in duration-500 pb-20">
      ...
      <div className="flex items-center gap-4 mb-2">
       ...
       <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          iconBg="bg-blue-600"
          label="Banco"
          value={conta.codigo_banco || 'N/A'}
        />
        <StatCard
          icon={Hash}
          iconBg="bg-indigo-600"
          label="Código Omie"
          value={conta.nCodCC.toString()}
        />
        <StatCard
          icon={CreditCard}
          iconBg="bg-zinc-600"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* ── CONFIGURAÇÕES ── */}
          <SectionCard icon={ShieldCheck} iconColor="text-emerald-500" title="Configurações e Integração">
             <div className="space-y-0">
                <InfoRow label="Saldo Inicial" value={formatCurrency(conta.saldo_inicial)} className="text-white font-bold" />
                <InfoRow label="Enviar para PDV" value={conta.pdv_enviar === 'S' ? 'Sim' : 'Não'} />
                <InfoRow label="Tipo Curto" value={conta.tipo} />
             </div>
          </SectionCard>
        </div>
